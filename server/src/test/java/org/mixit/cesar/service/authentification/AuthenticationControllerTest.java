...
public class AuthenticationControllerTest {
    ...
    @Before
    public void setUp() {
        AuthenticationController authenticationController = new AuthenticationController(accountRepository, oauthFactory, applicationContext, urlFactory, accountService);
    ...
    public void should_login_when_credentials_are_valids() throws Exception {
        when(accountRepository.findByLogin("mylogin")).thenReturn(new Account().setLogin("mylogin").setPassword("password").setValid(true));
    ...
    @Test
    public void should_not_login_when_account_not_validated() throws Exception {
