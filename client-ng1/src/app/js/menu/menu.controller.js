(function () {
  ...
  angular.module('cesar-menu').controller('cesarMenuCtrl', function ($state, $timeout, LanguageService, $scope) {
    'ngInject';
    ...
    $timeout(function(){
      $scope.currentLanguage = LanguageService.setDefaultLanguage();
    });
    $scope.toggleLanguage = function () {
      $scope.currentLanguage = LanguageService.toggleLanguage();
    };
    ...
    //     {id: 'menu.timeline', link: 'timeline', mobile: true},
